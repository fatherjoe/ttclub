 ...
 */
class TtclubViewTeams extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_TTCLUB_TITLE_TEAMS'), 'teams.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_ttclub&view=teams');
