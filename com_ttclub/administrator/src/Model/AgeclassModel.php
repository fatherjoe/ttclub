...
class AgeclassModel extends AdminModel
{
    /**
     ...
     * @var string
     */
    public $typeAlias = 'com_ttclub.ageclass';
    ...
    {
        $data = Factory::getApplication()->getUserState('com_ttclub.edit.ageclass.data', []);
     ...
     */
    public function getTable($name = 'Ageclass', $prefix = 'Administrator', $options = []): Table
    {
