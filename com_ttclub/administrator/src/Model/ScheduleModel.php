...
class ScheduleModel extends AdminModel
{
     ...
     * @var string
     */
    public $typeAlias = 'com_ttclub.schedule';
    ...
    {
        $data = Factory::getApplication()->getUserState('com_ttclub.edit.schedule.data', []);
     ...
     */
    public function getTable($name = 'Schedule', $prefix = 'Administrator', $options = []): Table
    {
