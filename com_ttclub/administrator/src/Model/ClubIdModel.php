...
class ClubidModel extends AdminModel
{
    /**
     ...
     * @var string
     */
    public $typeAlias = 'com_ttclub.clubid';
    ...
    {
        $data = Factory::getApplication()->getUserState('com_ttclub.edit.clubid.data', []);
     ...
     */
    public function getTable($name = 'Clubid', $prefix = 'Administrator', $options = []): Table
    {
