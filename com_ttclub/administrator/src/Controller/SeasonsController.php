...
{
    public function getModel($name = 'Season', $prefix = 'Administrator', $config = ['ignore_request' => true]): mixed
    {
    ...
    public function delete(): void
    {
        ...
        if (!$user->authorise('core.admin', 'com_ttclub')
            ...
            $this->setRedirect(Route::_('index.php?option=com_ttclub&view=seasons', false));
