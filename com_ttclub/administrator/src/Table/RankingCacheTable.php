...
/**
 * Ranking Cache table class.
 *
 * Stores cached league ranking table HTML fetched from click-tt.de,
 * keyed by team and half-season with a timestamp for cache expiry.
 */
class RankingCacheTable extends Table
{
    /**
     * Constructor.
     *
    ...
    {
        parent::__construct('#__ttclub_ranking_cache', 'id', $db);
    }
    ...
    public function check(): bool
    {
        ...
        if (empty($this->ranking_html)) {
            $this->setError('Ranking HTML content is required.');
            return false;
        }
