...
namespace Fatherjoe\Component\Ttclub\Administrator\View\Leagues;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        ToolbarHelper::title(Text::_('COM_TTCLUB_LEAGUES_TITLE'), 'list');
        ...
        ToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'leagues.delete');
    }
}
