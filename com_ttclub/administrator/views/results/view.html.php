 ...
 */
class TtclubViewResults extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        TtclubHelper::addSubmenu('results');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_TTCLUB_TITLE_RESULTS'), 'results.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_ttclub&view=results');
