...
class WebttModelSpielplan extends JModelItem
{
        ...
        public function getXMLPopups()
        {
				...
				{
						// ÜBERPRÜFEN, OB EIN ERGEBNIS EINGETRAGEN WURDE
						if (isset($zeile->ERGEBNIS_PFAD) && $zeile->ERGEBNIS_PFAD)
						{
								...
								// Array mit clicktt-meeting-nrn aufbauen, um die 
								$idsclicktt[] = $meeting;
						}
				}
                ...
                if (isset($idsclicktt))
                {
						...
						// Objekt mit clicktt-meeting-nr xml erstellen und zurückgeben
